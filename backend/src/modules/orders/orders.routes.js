...
import { changeOrderStatus, getOrder, getOrders, patchOrderAssignment, storeOrder } from "./orders.controller.js";
...
router.patch("/:id/assign", requireRole("SUPER_ADMIN", "ADMIN"), patchOrderAssignment);
