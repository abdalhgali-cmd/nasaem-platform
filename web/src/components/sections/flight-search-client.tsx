...
export function FlightSearchClient() {
  ...
  return <>
    <section className="relative overflow-hidden bg-primary py-16 text-primary-foreground"><Container><div className="mx-auto max-w-4xl text-center"><div className="mx-auto flex size-14 items-center justify-center rounded-2xl bg-white/10"><Plane className="size-7" /></div><p className="mt-5 text-sm font-bold text-secondary">حجز الطيران</p><h1 className="mt-2 text-3xl font-black sm:text-5xl">ابحث عن رحلتك</h1><p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-primary-foreground/75 sm:text-base">رحلات الطيران السودانية من مخزون الوكالة، والرحلات الدولية من مزود Trip، مع تحويل السعر تلقائيًا إلى الجنيه السوداني حسب سعر الصرف المعتمد.</p></div></Container></section>
