...
function formatSdg(value?: number | null) { return value == null ? "غير متاح" : `${new Intl.NumberFormat("ar-SD").format(Math.round(value))} ج.س`; }
